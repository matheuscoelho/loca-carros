							...
							<div className="row mt-60">
									...
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-1.svg" alt="Iuri" />
											</div>
										</div>
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-2.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-3.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-4.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-5.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-6.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-7.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-8.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-10.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-11.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-12.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-13.svg" alt="Iuri" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
