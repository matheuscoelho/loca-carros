											...
											<div className="card-info-blog">
												...
												<div className="card-meta-user">
													<div className="box-author-small">
														<img src="/assets/imgs/page/homepage1/avatar.png" alt="Iuri" />
										...
										<div className="col-lg-8">
											...
											<div className="box-grid-hotels box-grid-news mt-60 mb-50 wow fadeIn">
												<div className="card-flight card-news background-card">
													<div className="card-image">
														<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/news.png" alt="Iuri" /></Link>
													</div>
													<div className="card-info">
												...
												<div className="card-flight card-news background-card">
													<div className="card-image">
														<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/news2.png" alt="Iuri" /></Link>
													</div>
													<div className="card-info">
												...
												<div className="card-flight card-news background-card">
													<div className="card-image">
														<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/news3.png" alt="Iuri" /></Link>
													</div>
													<div className="card-info">
												...
												<div className="card-flight card-news background-card">
													<div className="card-image">
														<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/news4.png" alt="Iuri" /></Link>
													</div>
													<div className="card-info">
