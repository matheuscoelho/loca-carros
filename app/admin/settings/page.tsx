										...
										<div className="d-flex justify-content-between align-items-center">
											<div>
												...
												<p className="text-muted small mb-0">
													Exibe um banner vermelho no topo do site informando que é um projeto demonstrativo
												</p>
											</div>
											<div className="form-check form-switch">
												<input
													...
													id="showDemoBanner"
													checked={settings.general.showDemoBanner ?? true}
													onChange={(e) => setSettings(prev => ({
														...prev,
														general: { ...prev.general, showDemoBanner: e.target.checked }
													}))}
