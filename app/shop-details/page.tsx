									...
									<div className="container-banner-activities">
										<div className="box-banner-activities border rounded-3 overflow-hidden">
											<Slider
												...
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="Iuri" /></div>
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="Iuri" /></div>
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="Iuri" /></div>
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="Iuri" /></div>
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="Iuri" /></div>
										...
										<div className="slider-thumnail-activities">
											<Slider
												...
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-1.png" alt="Iuri" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-2.png" alt="Iuri" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-3.png" alt="Iuri" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-4.png" alt="Iuri" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-1.png" alt="Iuri" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-2.png" alt="Iuri" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-3.png" alt="Iuri" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-4.png" alt="Iuri" /></div>
								...
								<div className="col-lg-6 ps-lg-4">
									<div className="tour-header">
										<div className="d-flex flex-wrap align-items-center gap-4 mb-3">
											...
											<Link href="#">
												<img src="/assets/imgs/shop/shop-list/stock.png" alt="Iuri" />
											</Link>
										</div>
													...
													<div className="list-reviews">
														<div className="item-review">
															<div className="head-review">
																...
																<div className="rate-review"><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="Iuri" /> <img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="Iuri" /> <img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="Iuri" /> <img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="Iuri" /> <img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="Iuri" /></div>
															</div>
