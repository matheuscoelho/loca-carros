					...
					<div className="page-header-2 pt-30 background-body">
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img className="w-100 h-100 img-fluid img-banner" src="/assets/imgs/page-header/banner9.png" alt="Iuri" />
							</div>
						...
						<div className="container">
							<div className="row align-items-end">
								<div className="col-md-9 mb-30 wow fadeInUp">
									...
									<p className="text-lg-medium text-bold neutral-500">Experience The Best Car Services In Iuri</p>
								</div>
							</div>
						</div>
					</section>
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product1.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														...
														<div className="card-program">
															...
															<div className="endtime pt-3 mt-3 border-top">
																...
																<Link href="#" className="card-button pe-3"><img src="/assets/imgs/shop/shop-list/stock.png" alt="Iuri" /></Link>
															</div>
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product2.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product3.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product4.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product5.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product6.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product7.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product8.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product9.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product10.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product11.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product12.png" alt="Iuri" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="block-filter border-1">
												...
												<div className="d-flex justify-content-between pt-20 border-top">
													...
													<Link href="#" className="btn btn-primary px-3 py-2">
														<img src="/assets/imgs/template/icons/user.svg" alt="Iuri" />
														Apply
													</Link>
												</div>
											</div>
													...
													<ul className="list-filter-checkbox">
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /></span><span className="checkmark" />
															</label>
														</li>
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /></span><span className="checkmark" />
															</label>
														</li>
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /></span><span className="checkmark" />
															</label>
														</li>
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /></span><span className="checkmark" />
															</label>
														</li>
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="Iuri" /></span><span className="checkmark" />
															</label>
														</li>
													</ul>
												</div>
