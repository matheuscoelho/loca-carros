								...
								<div className="swiper-wrapper">
									<SwiperSlide>
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-1.png" alt="Iuri" />
												</Link>
											</div>
										...
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-2.png" alt="Iuri" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
										...
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-3.png" alt="Iuri" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
									...
									<SwiperSlide>
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-4.png" alt="Iuri" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
										...
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-5.png" alt="Iuri" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
										...
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-6.png" alt="Iuri" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
