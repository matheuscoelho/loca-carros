						...
						<div className="row">
							<div className="col-lg-3 col-sm-6">
								<div className="card-popular background-card hover-up wow fadeIn" data-wow-delay="0.1s">
									<div className="card-image">
										<Link className="card-title" href="/cars-list-1"><img src="/assets/imgs/categories/categories-1/car-1.png" alt="Iuri" /></Link>
									</div>
							...
							<div className="col-lg-3 col-sm-6">
								<div className="card-popular background-card hover-up wow fadeIn" data-wow-delay="0.2s">
									<div className="card-image">
										<Link className="card-title" href="/cars-list-1"><img src="/assets/imgs/categories/categories-1/car-2.png" alt="Iuri" /></Link>
									</div>
									<div className="card-info">
							...
							<div className="col-lg-3 col-sm-6">
								<div className="card-popular background-card hover-up wow fadeIn" data-wow-delay="0.3s">
									<div className="card-image">
										<Link className="card-title" href="/cars-list-1"><img src="/assets/imgs/categories/categories-1/car-3.png" alt="Iuri" /></Link>
									</div>
									<div className="card-info">
							...
							<div className="col-lg-3 col-sm-6">
								<div className="card-popular background-card hover-up wow fadeIn" data-wow-delay="0.4s">
									<div className="card-image">
										<Link className="card-title" href="/cars-list-1"><img src="/assets/imgs/categories/categories-1/car-4.png" alt="Iuri" /></Link>
									</div>
									<div className="card-info">
							...
							<div className="col-lg-3 col-sm-6">
								<div className="card-popular background-card hover-up wow fadeIn" data-wow-delay="0.1s">
									<div className="card-image">
										<Link className="card-title" href="/cars-list-1"><img src="/assets/imgs/categories/categories-1/car-5.png" alt="Iuri" /></Link>
									</div>
									<div className="card-info">
							...
							<div className="col-lg-3 col-sm-6">
								<div className="card-popular background-card hover-up wow fadeIn" data-wow-delay="0.2s">
									<div className="card-image">
										<Link className="card-title" href="/cars-list-1"><img src="/assets/imgs/categories/categories-1/car-6.png" alt="Iuri" /></Link>
									</div>
									<div className="card-info">
							...
							<div className="col-lg-3 col-sm-6">
								<div className="card-popular background-card hover-up wow fadeIn" data-wow-delay="0.3s">
									<div className="card-image">
										<Link className="card-title" href="/cars-list-1"><img src="/assets/imgs/categories/categories-1/car-7.png" alt="Iuri" /></Link>
									</div>
									<div className="card-info">
							...
							<div className="col-lg-3 col-sm-6">
								<div className="card-popular background-card hover-up wow fadeIn" data-wow-delay="0.4s">
									<div className="card-image">
										<Link className="card-title" href="/cars-list-1"><img src="/assets/imgs/categories/categories-1/car-8.png" alt="Iuri" /></Link>
									</div>
									<div className="card-info">
