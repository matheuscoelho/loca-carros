								...
								<SwiperSlide>
									<div className="item-banner-slide banner-1">
										<div className="container">
											...
											<h1 className="mt-20 mb-20 color-white">{t('findNextVehicle')}</h1>
											<h6 className="color-white heading-6-medium pb-lg-0 pb-4">
												{t('browseInventory')}
											</h6>
											<span className="text-lg-medium color-white d-lg-none">{t('discountApp')} <Link className="text-primary" href="#install-app">{t('orderingViaApp')}</Link></span>
										</div>
									</div>
								</SwiperSlide>
								<SwiperSlide>
									<div className="item-banner-slide banner-2">
										<div className="container">
											<span className="btn background-brand-2 px-3 py-3 rounded-12 text-sm-bold text-dark">{t('bestRentalSystem')}</span>
											<h1 className="mt-20 mb-20 color-white">{t('discoverNextRide')}</h1>
				...
				<div className="container-search-advance">
					<div className="container">
						...
						<div className="align-items-center justify-content-between pt-40 d-none d-lg-flex">
							<span className="text-lg-medium color-white">{t('discountApp')} <Link className="text-primary" href="#install-app">{t('orderingViaApp')}</Link></span>
