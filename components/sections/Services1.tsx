							...
							<Swiper {...swiperGroup4} className="swiper-container swiper-group-4 swiper-group-journey">
								<div className="swiper-wrapper">
									<SwiperSlide>
										<div className="card-spot background-card wow fadeInDown">
											<div className="card-image">
												<Link href="/services"><img className="rounded-3" src="/assets/imgs/services/services-1/img-1.png" alt="Iuri" /></Link>
											</div>
									...
									<SwiperSlide>
										<div className="card-spot background-card wow fadeInDown">
											<div className="card-image">
												<Link href="/services"><img className="rounded-3" src="/assets/imgs/services/services-1/img-2.png" alt="Iuri" /></Link>
											</div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<SwiperSlide>
										<div className="card-spot background-card wow fadeInDown">
											<div className="card-image">
												<Link href="/services"><img className="rounded-3" src="/assets/imgs/services/services-1/img-3.png" alt="Iuri" /></Link>
											</div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<SwiperSlide>
										<div className="card-spot background-card wow fadeInDown">
											<div className="card-image">
												<Link href="/services"><img className="rounded-3" src="/assets/imgs/services/services-1/img-4.png" alt="Iuri" /></Link>
											</div>
											<div className="card-info background-card">
												<div className="card-left">
