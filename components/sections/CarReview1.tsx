						...
						<div className="row">
							<div className="col-lg-7">
								<div className="card-grid-video wow fadeIn">
									<div className="card-image"><a className="btn btn-play popup-youtube" onClick={() => setOpen(true)}> </a><img className="mr-10" src="/assets/imgs/car-review/car-review-1/img-video-1.png" alt="Iuri" /></div>
							...
							<div className="col-lg-5">
								<div className="list-videos-small">
									<div className="item-video-small wow fadeIn" data-wow-delay="0.1s">
										<div className="item-image"><a className="btn-play-sm popup-youtube" onClick={() => setOpen(true)}> </a><img className="mr-10" src="/assets/imgs/car-review/car-review-1/img-video-2.png" alt="Iuri" />
										</div>
									...
									<div className="item-video-small wow fadeIn" data-wow-delay="0.2s">
										<div className="item-image"><a className="btn-play-sm popup-youtube" onClick={() => setOpen(true)}> </a><img className="mr-10" src="/assets/imgs/car-review/car-review-1/img-video-3.png" alt="Iuri" />
										</div>
										<div className="item-info">
									...
									<div className="item-video-small wow fadeIn" data-wow-delay="0.3s">
										<div className="item-image"><a className="btn-play-sm popup-youtube" onClick={() => setOpen(true)}> </a><img className="mr-10" src="/assets/imgs/car-review/car-review-1/img-video-4.png" alt="Iuri" />
										</div>
										<div className="item-info">
