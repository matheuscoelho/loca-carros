						...
						<div className="col-lg-4 offset-lg-1 wow fadeIn">
							<div className="box-authors-partner background-body wow fadeInUp p-4">
								<div className="authors-partner-left">
									<img src="/assets/imgs/page/homepage5/author.png" alt="Iuri" /><img src="/assets/imgs/page/homepage5/author2.png" alt="Iuri" /><img src="/assets/imgs/page/homepage5/author3.png" alt="Iuri" />
								...
								<div className="authors-partner-right">
									<p className="text-sm neutral-1000">1684 people used <strong>Iuri </strong>in the last
